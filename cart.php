	...
	<section id="cart_items">
		<div class="container">
			...
			<div class="table-responsive cart_info">
					...
					echo "<b>Bienvenido:</b>" . $_SESSION['customer_email'] . "<b style='color:yellow;'>Your</b>" ;
					}
					else {
...
for($i = 0;$i< $_SESSION['contador'];$i++){
	...
	while($fila = mysqli_fetch_array($resultado)) {
		echo "<hr> <td><td> <tr><tr><td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$_SESSION['cantidad'][$i]."</td><td><td>".$fila['product_title']."</td><td></td><td>".number_format(($_SESSION['cantidad'][$i]*$fila['product_price']),2)."</tr>";
	$suma += $_SESSION['cantidad'][$i]*$fila['product_price'];
	}
}
echo "<tr><td></td><td><td></td><td style=color:'9px solid red;'>Subtotal:</td><td>".number_format($suma,2)."</td></tr>";
echo "</div>";
						...
						<img src="admin_area/product_images/<?php echo $product_image;?>" width="60" height="60"/>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									...
									<input class="cart_quantity_input" type="text" name="qty" value="<?php echo $_SESSION['qty'];?>" autocomplete="off" size="2">

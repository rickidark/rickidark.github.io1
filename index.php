					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<!-- <li><a href="checkout.html"><i class="fa fa-crosshairs"></i> Echa un Vistazo</a></li> -->
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1>Zafiro-<span>AZUL</span></h1>
									<h2>Anillos</h2>
									<p>Contamos con los mejores anillos de oro y plata con una gran variedad de diseño. </p>
									<button type="button" class="btn btn-default get">Cotizar ahora</button>
								</div>
								<div class="col-sm-6">
							...
							<div class="item">
								<div class="col-sm-6">
									<h1>Zafiro-<span>AZUL</span></h1>
									<h2>Pulseras</h2>
									<p>Los mejores modelos en cuanto a pulseras de oro y plata y finos acabados. </p>
									<button type="button" class="btn btn-default get">Cotizar ahora</button>
								</div>
								<div class="col-sm-6">
							...
							<div class="item">
								<div class="col-sm-6">
									<h1>Zafiro-<span>AZUL</span></h1>
									<h2>Collares</h2>
									<p>Gran variedad de personalizacion para la persona que mas amas en la vida. </p>
									<button type="button" class="btn btn-default get">Cotizar ahora</button>
								</div>
								<div class="col-sm-6">
								...
								<div id="sportswear" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											...
											<li><a href="#">Laminado</a></li>
											<li><a href="#">Enchapado </a></li>
										</ul>
									</div>
								</div>
							</div>

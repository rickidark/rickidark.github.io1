			...
			<div class="row">
				...
				<ul>
								...
								<div id="sportswear" class="panel-collapse expand">
									...
									<div class="panel-body">
			<div id="carrito" style="background-color:#4179f7;color:black;">
			
			Carrito
			</div>
			<a href='php/destruir.php'><button>Vaciar</button></a>
			<a href='confirmar.php'><button>Comprar</button></a>
			</div>
								</div>
							</div>
...
while($fila = mysqli_fetch_array($resultado)) {
	echo "<article>";
	$peticion2 = "SELECT * FROM products WHERE product_brand = ".$fila['product_id']." LIMIT 1";
	$resultado2 = mysqli_query($conexion, $peticion2);
	while($fila2 = mysqli_fetch_array($resultado2)) {
		echo "<img src='admin_area/product_images/".$fila2['product_image']."' width=100px>";
	}
	
	echo "<a href='caballeros.php?id=".$fila['product_id']."'><h3>".$fila['product_title']."</h3></a>";
	echo "<p>".$fila['product_desc']."</p>";
	echo "<p>Precio: ".$fila['product_price']." Pesos</p>";
	echo "<input type='number' value='1' max='5' min='1' id='num".$fila['product_id']."'>";
	echo "<br>";
	echo "<a href='caballeros.php?id=".$fila['product_id']."'><button>Más información</button></a>";
	echo "<button value='".$fila['product_id']."' class='botoncompra'>Comprar ahora</button>";
	echo "</article>";
} 

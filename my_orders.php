...
switch($estado){
	...
	echo'><td class="fila">'.$fila['customer_name']." ".$fila['apellidos'].'</td><td class="fila">'.date("M d Y H:i:s",$fila['fecha']).'</td><td class="fila">'.$diestado.'</td><td class="fila"><a href="../php/pedidoservido.php?id='.$fila['idpedido'].'"><button>Pedido servido</button></a></td><td class="fila"><a href="../php/cancelarpedido.php?id='.$fila['idpedido'].'"><button>Cancelar pedido</button></a></td></tr>';
} 

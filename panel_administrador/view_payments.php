<head><link rel="stylesheet" href="/styles/tabla.css"></head>
<table width="795" align="center" bgcolor="pink"> 
	...
	while ($row_payment=mysqli_fetch_array($run_payment)){
		...
		$get_c = "select * from clientes where customer_id='$c_id'";
	...
	<tr align="center">
		...
		<img src="../panel_administrador/product_images/<?php echo $pro_image;?>" width="50" height="50" />
		</td>

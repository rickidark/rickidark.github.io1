...
if(isset($_GET['edit_pro'])){
	...
	$row_pro=mysqli_fetch_array($run_pro);
		...
		$pro_tipoproducto = $row_pro['tipo_producto'];
		...
		$get_tipoproducto = "select * from tiposproducto where tipoproducto_id='$pro_tipoproducto'";
...
<body bgcolor="skyblue">
	...
	<form action="" method="post" enctype="multipart/form-data"> 
		...
		<table align="center" class="editar_productos" border="2" bgcolor="#187eae">
			...
			<tr align="center">
				<td colspan="7"><h2>Editar y actualizar productos</h2></td>
			</tr>
			...
			<tr class="editar_productos">
				...
				<select name="product_cat" required>
					<option required><?php echo $category_title; ?></option>
					<?php 
		...
		echo "<option value='$cat_id' required>$cat_title</option>";
			...
			<tr class="editar_productos">
				...
				<select name="tipo_producto"  required>
					<option required><?php echo $nombre_tipoproducto; ?></option>
					<?php 
	...
	echo "<option value='$tipoproducto_id' required >$nombre_tipoproducto</option>";
			...
			<tr class="editar_productos">
				...
				<td><input type="file" name="product_image" accept="image/*" required /><img src="product_images/<?php echo $pro_image; ?>" width="60" height="60"/></td>
			</tr>
			
			<tr class="editar_productos">
				<td align="right"><b>Precio del producto:</b></td>
				<td><input type="number" name="product_price" value="<?php echo $pro_price;?>" required/></td>
			</tr>
			...
			<tr align="center" class="editar_productos">
				<td colspan="7"><input type="submit" name="update_product" value="Actualizar producto"/></td>
			</tr>
...
<?php 
	...
	if(isset($_POST['update_product'])){
		...
		move_uploaded_file($product_image_tmp,"product_images/$product_image");
		 ...
		 $update_product = "update products set product_cat='$product_cat',tipo_producto='$tipo_producto',product_title='$product_title',product_price='$product_price',product_desc='$product_desc',product_image='$product_image', existencias='$existencias', product_keywords='$product_keywords' where product_id='$update_id'";
